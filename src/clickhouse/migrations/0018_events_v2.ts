...
;
RENAME TABLE {database}.events TO {database}.events_legacy
;
RENAME TABLE {database}.events_v2 TO {database}.events
`,
  down: `
RENAME TABLE {database}.events TO {database}.events_v2
;
RENAME TABLE {database}.events_legacy TO {database}.events
;
