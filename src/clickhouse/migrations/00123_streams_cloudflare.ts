...
export const migration: Migration = {
  version: 123,
  name: 'streams_cloudflare',
  up: `
CREATE TABLE IF NOT EXISTS streams.cloudflare (
...
;
CREATE MATERIALIZED VIEW IF NOT EXISTS streams.cloudflare_mv
TO streams.cloudflare AS
SELECT
...
WHERE ev.source = 'cloudflare'
`.trim(),
  down: `
DROP VIEW IF EXISTS streams.cloudflare_mv;
DROP TABLE IF EXISTS streams.cloudflare
`.trim(),
}
